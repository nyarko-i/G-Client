...
const tracksData: TrackData[] = [
  {
    ...
    price: 400,
    duration: "12 weeks",
    image: "/images/tracks/software.jpg",
...
function TrackCard({ track, index }: { track: TrackData; index: number }) {
  ...
  return (
    <Card
      className={`overflow-hidden border-0 transform transition-all duration-700 
      hover:scale-[1.03] hover:shadow-xl hover:-translate-y-1 cursor-pointer
